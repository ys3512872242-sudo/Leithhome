...
const CACHE_NAME = "companion-shell-20260722-wardrobe-workflow-v34";
const SHELL_FILES = ["./index.html", "./app.js", "./memory.js", "./wardrobe/catalog.js", "./manifest.webmanifest", "./icon-leith-v2-192.png", "./icon-leith-v2-512.png"];

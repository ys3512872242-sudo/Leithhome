...
const CACHE_NAME = "companion-shell-20260806-emotion-photo-modules-v1";
const SHELL_FILES = ["./index.html", "./app.js", "./memory.js", "./desire-engine.js", "./desire-runtime.js", "./wardrobe/catalog.js", "./manifest.webmanifest", "./icon-leith-v2-192.png", "./icon-leith-v2-512.png"];
